    ...
    virtual void BackpropToNonLooping(size_t inputIndex) override
    {
        if (inputIndex == 1)
        {
            ...
            if (m_totalFrameNumberOfCurrentMinibatch == 0 || m_frameNumberOfCurrentMinibatch == m_totalFrameNumberOfCurrentMinibatch)
            {
                ...
                //fprintf(stderr, "Total LFMMI gradient mean %lf sq %lf\n", m_mbGradients->SumOfElements(), m_mbGradients->FrobeniusNorm());
            }
            ...
            if (m_totalFrameNumberOfCurrentMinibatch > 0)
            {
                ...
                //fprintf(stderr, "LFMMI %zd gradient mean %lf sq %lf\n", m_frameNumberOfCurrentMinibatch, gradient.SumOfElements(), gradient.FrobeniusNorm());
